...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.001)
sys.stdout.write('\x1b[1;35m\x1b]2; Tajul Islam Rabbi \x07')
...
\x1b[38;5;46m______________________________________________________
 \033[1;31m[\033[1;32m[H]\033[1;31m]\033[1;32m DEVELOPER : Tajul Islam Rabbi
 \033[1;31m[\033[1;32m[R]\033[1;31m]\033[1;32m DEVELOPER : Tajul Islam
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/Hacker1414');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	kode = input(' ┗━[+] SELECT : ')
	doamin = ' BD Number id cloner [RABBI-OK] '
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m[RABBI]\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Hacker1414/PAID-TEST/blob/main/CONTROL.tex").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am RABBI VAI er  ROBOT and my boss is hridoye.Sir this tool is paid because 100% ok id just now login\"")
